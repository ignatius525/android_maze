...
public interface Robot {
	 ...
	 */
	void setController(PlayAnimationFragment controller);

	void setMaze(Maze mazeConfig);
	/**
	 ...
	 */
	void move(int distance) throws IllegalArgumentException;
	/**
	...
	/**
	 * Toggles full map and shows solution for automated mode. Is kicked off as soon as
	 * drive2exit() is called. Put this here so that any robot we are to make can automatically display
	 * the full map and solution.
	 */
	void toggleMapAndSolution();
	/////// OPTIONAL METHODS /////////////////////////////////////////////
