...
import edu.wm.cs.cs301.IgnatMiagkov.generation.BSPBranch;
import edu.wm.cs.cs301.IgnatMiagkov.generation.BSPLeaf;
import edu.wm.cs.cs301.IgnatMiagkov.generation.BSPNode;
import edu.wm.cs.cs301.IgnatMiagkov.generation.Floorplan;
import edu.wm.cs.cs301.IgnatMiagkov.generation.Wall;
...
//        gc = (Graphics2D) g ;
	 ...
	 */
	private void drawBackground(final MazePanel panel, float percentToExit) {
...
//		graphics.fillRect(0, viewHeight/2, viewWidth, viewHeight/2);
		panel.addBackground(percentToExit, viewWidth, viewHeight);
	}
	/**
