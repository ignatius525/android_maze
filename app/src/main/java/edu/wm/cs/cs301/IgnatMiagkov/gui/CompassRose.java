...
import edu.wm.cs.cs301.IgnatMiagkov.gui.P5PanelF21.P5RenderingHints;
...
public class CompassRose {
	...
	private static final int greenWM = Integer.decode("#115740");
	private static final int goldWM = Integer.decode("#916f41");
	private static final int colorWhite = Integer.decode("#FFFFFF");
...
//    private static final Color CIRCLE_HIGHLIGHT = new Color(1.0f, 1.0f, 1.0f, 0.8f);
    private static final int CIRCLE_HIGHLIGHT = Integer.decode("#115740");
...
//    private static final Color CIRCLE_SHADE = new Color(1.0f, 1.0f, 1.0f, 0.3f); 
    private static final int CIRCLE_SHADE = Integer.decode("#115740");
    //Color.decode("#115740").brighter(); //new Color(0.0f, 0.0f, 0.0f, 0.2f); 
    
    // fixed configuration for letters used to indicate direction
    private static final int MARKER_COLOR = Integer.decode("#000000");
    /**
...
//        final Graphics2D panel = (Graphics2D) g;
        /* Original code
